...
import { readFile as d, writeFile as f } from "node:fs/promises";
import { createRequire as e } from "node:module";
import { basename as p, join as m, relative as h, resolve as g } from "node:path";
...
`,
  ...
  N = v((e, t) => {
    let n = y(`node:assert`),
      ...
      { IncomingMessage: s } = y(`node:http`),
      c = y(`node:stream`),
      l = y(`node:net`),
      { Blob: u } = y(`node:buffer`),
      d = y(`node:util`),
      { stringify: f } = y(`node:querystring`),
      { EventEmitter: p } = y(`node:events`),
      { InvalidArgumentError: m } = A(),
      { headerNameLowerCasedRecord: h } = j(),
      { tree: g } = M(),
      [_, v] = process.versions.node.split(`.`).map((e) => Number(e));
    var b = class {
      constructor(e) {
        ((this[o] = e), (this[i] = !1));
      }
  ...
  P = v((e, t) => {
    let n = y(`node:diagnostics_channel`),
      r = y(`node:util`),
      i = r.debuglog(`undici`),
      a = r.debuglog(`fetch`),
  ...
  F = v((e, t) => {
    let { InvalidArgumentError: n, NotSupportedError: r } = A(),
      ...
      { channels: _ } = P(),
      { headerNameLowerCasedRecord: v } = j(),
      b = /[^\u0021-\u00ff]/,
      x = Symbol(`handler`);
    var S = class {
      constructor(
      ...
      onComplete(e) {
        (this.onFinally(),
          i(!this.aborted),
          (this.completed = !0),
          _.trailers.hasSubscribers && _.trailers.publish({ request: this, trailers: e }));
        try {
      ...
      onError(e) {
        if (
          (this.onFinally(),
          _.error.hasSubscribers && _.error.publish({ request: this, error: e }),
          !this.aborted)
        )
    ...
    function C(e, t, i) {
      ...
      if (i === void 0) return;
      let s = v[t];
      if (s === void 0 && ((s = t.toLowerCase()), v[s] === void 0 && !a(s)))
  ...
  L = v((e, t) => {
    let n = I(),
      { ClientDestroyedError: r, ClientClosedError: i, InvalidArgumentError: a } = A(),
      { kDestroy: o, kClose: s, kClosed: c, kDestroyed: l, kDispatch: u, kInterceptors: d } = k(),
    ...
    t.exports = class extends n {
      ...
      get webSocketOptions() {
        return { maxPayloadSize: this[h].maxPayloadSize ?? 128 * 1024 * 1024 };
      }
      get destroyed() {
        return this[l];
      }
    ...
    function d({ allowH2: e, maxCachedSessions: t, socketPath: o, timeout: s, session: c, ...d }) {
      ...
      return (
        ...
        function (
          ...
          let b = f(new WeakRef(v), { timeout: s, hostname: t, port: u });
          return (
            v
              .setNoDelay(!0)
  ...
  V = v((e, t) => {
    ...
    function c(e) {
      ...
      let s = g(i);
      return (s === `failure` && (s = g(`text/plain;charset=US-ASCII`)), { mimeType: s, body: o });
    }
    function l(e, t = !1) {
      if (!t) return e.href;
      let n = e.href,
    ...
    function v(e, t, r) {
      ...
      for (
        ...
        (a += u((e) => e !== `"` && e !== `\\`, e, t)), !(t.position >= e.length);
      ) {
        let r = e[t.position];
        if ((t.position++, r === `\\`)) {
  ...
  H = v((e, t) => {
    let { types: n, inspect: r } = y(`node:util`),
      { markAsUncloneable: i } = y(`node:worker_threads`),
      { toUSVString: a } = N(),
      o = {};
    ((o.converters = {}),
      (o.util = {}),
  ...
  U = v((e, t) => {
    let { Transform: n } = y(`node:stream`),
      r = y(`node:zlib`),
      { redirectStatusSet: i, referrerPolicySet: a, badPortsSet: o } = re(),
      ...
      { performance: f } = y(`node:perf_hooks`),
      {
        isBlobLike: p,
      ...
      _ = y(`node:assert`),
      { isUint8Array: v } = y(`node:util/types`),
      { webidl: b } = H(),
      x = [],
      S;
    try {
...
`) ||
  ...
  W = v((e, t) => {
    let { Blob: n, File: r } = y(`node:buffer`),
      { kState: i } = ae(),
      { webidl: a } = H();
    var o = class e {
      constructor(e, t, n = {}) {
  ...
  G = v((e, t) => {
    let { isBlobLike: n, iteratorMixin: r } = U(),
      ...
      { FileLike: o, isFileLike: s } = W(),
      { webidl: c } = H(),
      { File: l } = y(`node:buffer`),
      u = y(`node:util`),
      d = globalThis.File ?? l;
    var f = class e {
      constructor(e) {
...
`);
    ...
    function v(e, t) {
      ...
      for (f !== e.length && (e = e.subarray(0, f)); ; ) {
        ...
        (f === null
          ? (y = i(Buffer.from(v)))
          : ((p ??= `text/plain`), g(p) || (p = ``), (y = new d([v], f, { type: p }))),
          l(n(r)),
      ...
      for (;;) {
        ...
        switch ((t.position++, S((e) => e === 32 || e === 9, e, t), r(l))) {
          case `content-disposition`:
            if (((n = i = null), !w(e, f, t) || ((t.position += 17), (n = x(e, t)), n === null)))
              return `failure`;
            if (w(e, p, t)) {
...
`,
    ...
    t.exports = { multipartFormDataParser: v, validateBoundary: _ };
  }),
  oe = v((e, t) => {
    let n = N(),
      {
      ...
      { kState: f } = ae(),
      { webidl: p } = H(),
      { Blob: m } = y(`node:buffer`),
      h = y(`node:assert`),
      { isErrored: g, isDisturbed: _ } = y(`node:stream`),
      { isArrayBuffer: v } = y(`node:util/types`),
      { serializeAMimeType: b } = V(),
      { multipartFormDataParser: x } = K(),
      S;
    try {
      let e = y(`node:crypto`);
      S = (t) => e.randomInt(0, t);
    ...
    function w() {}
    let T = globalThis.FinalizationRegistry && process.version.indexOf(`v18`) !== 0,
      E;
    T &&
...
Content-Type: ${c.type || `application/octet-stream`}\r\n\r\n`,
  ...
  q = v((e, t) => {
    ...
    var ge = class {
      ...
      execute(e) {
        ...
        try {
          ...
          if (n === Y.ERROR.PAUSED_UPGRADE) this.onUpgrade(e.slice(r));
            ...
            throw new m(a, Y.ERROR[n], e.slice(r));
          }
        } catch (e) {
          r.destroy(t, e);
        }
      ...
      trackHeader(e) {
        ((this.headersSize += e),
          this.headersSize >= this.headersMaxSize && r.destroy(this.socket, new u()));
      }
      onUpgrade(e) {
      ...
      onHeadersComplete(e, t, i) {
        ...
        if (
          ...
          (this.shouldKeepAlive =
            i || (l.method === `HEAD` && !o[_] && this.connection.toLowerCase() === `keep-alive`)),
          this.statusCode >= 200)
        ) {
        ...
        return l.aborted
          ...
          : l.method === `HEAD` || e < 200
            ? 1
            : (o[x] && ((o[x] = !1), a[J]()), u ? Y.ERROR.PAUSED : 0);
      }
      onBody(e) {
      ...
      onMessageComplete() {
        ...
        if (
          ...
          if ((d.onComplete(o), (e[E][e[F]++] = null), t[T]))
            return (n(e[S] === 0), r.destroy(t, new f(`reset`)), Y.ERROR.PAUSED);
          if (!u || (t[_] && e[S] === 0)) return (r.destroy(t, new f(`reset`)), Y.ERROR.PAUSED);
          e[L] == null || e[L] === 1 ? setImmediate(() => e[J]()) : e[J]();
        }
      }
    };
    function _e(e) {
      ...
      i === 3
        ...
        : i === 5
          ? o || r.destroy(t, new p())
          : i === 8 && (n(a[S] === 0 && a[z]), r.destroy(t, new f(`socket idle timeout`)));
    }
      ...
      ((e[R] = t),
        ...
        ue(t, `close`, function () {
          let e = this[v],
            t = this[b];
          t &&
            (!this[I] && t.statusCode && !t.shouldKeepAlive && t.onMessageComplete(),
            this[b].destroy(),
            (this[b] = null));
          let i = this[I] || new d(`closed`, r.getSocketInfo(this));
          if (((e[R] = null), (e[se] = null), e.destroyed)) {
            n(e[C] === 0);
          ...
          ((e[M] = e[F]), n(e[S] === 0), e.emit(`disconnect`, e[g], [e], i), e[J]());
        }));
      let i = !1;
      return (
        t.on(`close`, () => {
    ...
    function xe(e, t) {
      let { method: a, path: s, host: l, upgrade: u, blocking: d, reset: p } = t,
      ...
      let b = e[R],
        S = (n) => {
          t.aborted ||
            t.completed ||
            (r.errorRequest(e, t, n || new c()), r.destroy(m), r.destroy(b, new f(`aborted`)));
        };
      try {
        t.onConnect(S);
      } catch (n) {
...
`,
  ...
  J = v((e, t) => {
    ...
    async function B(e, t) {
      ...
      let r = M.connect(e[l], { createConnection: () => t, peerMaxConcurrentStreams: e[S] });
      ((r[D] = 0),
        (r[d] = e),
        (r[v] = t),
        ...
        i.addListener(r, `close`, function () {
          let { [d]: e } = this,
            { [v]: t } = e,
            r = this[v][_] || this[_] || new s(`closed`, i.getSocketInfo(t));
    ...
    function ne(e) {
      let t = e[v];
      t?.destroyed === !1 &&
        (e[T] === 0 && e[S] === 0 ? (t.unref(), e[C].unref()) : (t.ref(), e[C].ref()));
    }
    function re(e) {
    ...
    function H(e) {
      let t =
          this[_] || new s(`HTTP/2: "GOAWAY" frame received with code ${e}`, i.getSocketInfo(this)),
        r = this[d];
      if (
        ((r[v] = null),
        (r[E] = null),
    ...
    function ae(e, t) {
      let r = e[C],
        { method: s, path: u, host: d, upgrade: f, expectContinue: p, signal: _, headers: y } = t,
        { body: x } = t;
      ...
      return (
        ...
        T.once(`response`, (n) => {
          ...
          (t.onHeaders(Number(r), te(a), T.resume.bind(T), ``) === !1 && T.pause(),
            T.on(`data`, (e) => {
      ...
      function B() {
        !x || M === 0
          ? W(A, T, null, e, t, e[v], M, j)
          : i.isBuffer(x)
            ? W(A, T, x, e, t, e[v], M, j)
            : i.isBlobLike(x)
              ? typeof x.stream == `function`
                ? q(A, T, x.stream(), e, t, e[v], M, j)
                : K(A, T, x, e, t, e[v], M, j)
              : i.isStream(x)
                ? G(A, e[v], j, T, x, e, t, M)
                : i.isIterable(x)
    ...
    function G(e, t, a, o, s, c, l, d) {
      ...
      let p = r(s, o, (n) => {
        n
          ? (i.destroy(p, n), e(n))
          : (i.removeAllListeners(p), l.onRequestSent(), a || (t[u] = !0), c[w]());
      });
  ...
  se = v((e, t) => {
      ...
      u = class {
        ...
        onHeaders(e, t, r, i) {
          ...
          let {
            ...
            c = s ? `${o}${s}` : o;
          ((this.opts.headers = p(this.opts.headers, e === 303, this.opts.origin !== a)),
            (this.opts.path = c),
            (this.opts.origin = a),
    ...
    function p(e, t, n) {
      let r = [];
      if (Array.isArray(e))
        for (let i = 0; i < e.length; i += 2) f(e[i], t, n) || r.push(e[i], e[i + 1]);
  ...
  ce = v((e, t) => {
    let n = y(`node:assert`),
      ...
      s = F(),
      c = L(),
      { InvalidArgumentError: l, InformationalError: u, ClientDestroyedError: d } = A(),
      f = R(),
      {
        kUrl: p,
        kServerName: m,
    ...
    var ge = class extends c {
      constructor(
        ...
        if ((super({ webSocket: oe }), g !== void 0))
        ...
        (typeof P != `function` &&
          (P = f({
            ...
            socketPath: S,
            timeout: u,
            ...(R ? { autoSelectFamily: R, autoSelectFamilyAttemptTimeout: W } : void 0),
            ...P,
          })),
          ...
          (this[v] = 0),
          (this[E] = 0),
          (this[O] = `host: ${this[p].hostname}${this[p].port ? `:${this[p].port}` : ``}\r\n`),
          (this[ie] = d ?? 3e5),
          (this[re] = o ?? 3e5),
          (this[V] = k ?? !0),
          (this[U] = N),
        ...
        return (
          ...
          this[v] ||
            (a.bodyLength(n.body) == null && a.isIterable(n.body)
              ? ((this[v] = 1), queueMicrotask(() => xe(this)))
              : this[fe](!0)),
          this[v] && this[E] !== 2 && this[g] && (this[E] = 2),
          this[E] < 2
        );
      }
      async [G]() {
    ...
    async function ye(e) {
      ...
      try {
        let r = await new Promise((n, r) => {
          e[H](
            { host: t, hostname: i, protocol: s, port: c, servername: e[m], localAddress: e[ce] },
            (e, t) => {
              e ? r(e) : n(t);
            },
          );
  ...
  ue = v((e, t) => {
    let { kFree: n, kConnected: r, kPending: i, kQueued: a, kRunning: o, kSize: s } = k(),
      c = Symbol(`pool`);
    t.exports = class {
      constructor(e) {
        this[c] = e;
        ...
        constructor(e) {
          ...
          ((this[b] = function (e, n) {
            ...
            ((this[_] = i),
              ...
              t[y] && r.isEmpty() && Promise.all(t[g].map((e) => e.close())).then(t[y]));
          }),
            (this[x] = (e, n) => {
  ...
  de = v((e, t) => {
    let { PoolBase: n, kClients: r, kNeedDrain: i, kAddClient: a, kGetDispatcher: o } = X(),
      s = ce(),
  ...
  pe = v((e, t) => {
    let { InvalidArgumentError: n } = A(),
      { kClients: r, kRunning: i, kClose: a, kDestroy: o, kDispatch: s, kInterceptors: c } = k(),
      l = L(),
      u = de(),
      d = ce(),
      f = N(),
  ...
  me = v((e, t) => {
    let { kProxy: n, kClose: r, kDestroy: i, kDispatch: a, kInterceptors: o } = k(),
      { URL: s } = y(`node:url`),
      c = pe(),
      l = de(),
      u = L(),
      { InvalidArgumentError: d, RequestAbortedError: f, SecureProxyConnectionError: p } = A(),
      m = R(),
      h = ce(),
    ...
    var O = class extends u {
        ...
        constructor(e, { headers: t = {}, connect: n, factory: r }) {
          ...
          ((this[v] = t),
            r ? (this.#e = r(e, { connect: n })) : (this.#e = new h(e, { connect: n })));
        }
        [a](e, t) {
          let n = t.onHeaders;
      ...
      j = class extends u {
        constructor(e) {
          ...
          let { proxyTunnel: r = !0 } = e,
            i = this.#e(e),
            { href: a, origin: l, port: u, protocol: h, username: y, password: k, hostname: A } = i;
          if (
            ...
            : e.token
              ...
              : y &&
                ...
                (this[v][`proxy-authorization`] =
                  `Basic ${Buffer.from(`${decodeURIComponent(y)}:${decodeURIComponent(k)}`).toString(`base64`)}`);
          let j = m({ ...e.proxyTls });
          ...
          let M = e.factory || D,
            N = (e, t) => {
              ...
              return !this[C] && r === `http:` && this[n].protocol === `http:`
                ? new O(this[n].uri, { headers: this[v], connect: j, factory: M })
                : M(e, t);
            };
              ...
              connect: async (e, t) => {
                ...
                try {
                  let { socket: r, statusCode: i } = await this[_].connect({
                    ...
                    path: n,
                    signal: e.signal,
                    headers: { ...this[v], host: e.host },
                    servername: this[x]?.servername || A,
                  });
                  if (
                    (i !== 200 &&
                      (r.on(`error`, E).destroy(),
                      t(new f(`Proxy response (${i}) !== 200 when HTTP Tunneling`))),
                    e.protocol !== `https:`)
                  ) {
                    t(null, r);
                    return;
  ...
  Q = v((e, t) => {
    let n = y(`node:assert`),
      ...
      { isDisturbed: a, parseHeaders: o, parseRangeHeader: s, wrapRequestBody: c } = N();
    function l(e) {
      let t = Date.now();
  ...
  $ = v((e, t) => {
    ...
    var _ = class extends r {
      ...
      destroy(e) {
        return (
          !e && !this._readableState.endEmitted && (e = new i()), e && this[p](), super.destroy(e)
        );
      }
      _destroy(e, t) {
        this[d]
      ...
      get body() {
        return (
          this[f] || ((this[f] = l(this)), this[u] && (this[f].getReader(), n(this[f].locked))),
          this[f]
        );
      }
      async dump(e) {
      ...
      return (
        ...
        new Promise((n, r) => {
          if (b(e)) {
            ...
            queueMicrotask(() => {
              ((e[u] = { type: t, stream: e, resolve: n, reject: r, length: 0, body: [] }),
                e
                  .on(`error`, function (e) {
                    D(this[u], e);
                  })
  ...
  _e = v((e, t) => {
    let n = y(`node:assert`),
      ...
      { AsyncResource: c } = y(`node:async_hooks`);
  ...
  be = v((e, t) => {
    let { Readable: n, Duplex: r, PassThrough: i } = y(`node:stream`),
      { InvalidArgumentError: a, InvalidReturnValueError: o, RequestAbortedError: s } = A(),
      c = N(),
      { AsyncResource: l } = y(`node:async_hooks`),
      { addSignal: u, removeSignal: d } = ve(),
      f = y(`node:assert`),
  ...
  xe = v((e, t) => {
    let { InvalidArgumentError: n, SocketError: r } = A(),
      { AsyncResource: i } = y(`node:async_hooks`),
      a = N(),
  ...
  Se = v((e, t) => {
    let n = y(`node:assert`),
      { AsyncResource: r } = y(`node:async_hooks`),
  ...
  Ee = v((e, t) => {
    let { MockNotMatchedError: n } = we(),
      { kDispatches: r, kMockAgent: i, kOriginalDispatch: a, kOrigin: o, kGetNetConnect: s } = Te(),
      { buildURL: c } = N(),
      { STATUS_CODES: l } = y(`node:http`),
      {
        types: { isPromise: u },
      } = y(`node:util`);
    function d(e, t) {
    ...
    function b(e, t) {
      let r = t.query ? c(t.path, t.query) : t.path,
        ...
        a = e.filter(({ consumed: e }) => !e).filter(({ path: e }) => d(g(e), i));
      ...
      if (((a = a.filter(({ body: e }) => (e === void 0 ? !0 : d(e, t.body)))), a.length === 0))
...
`.trim(),
  ...
  ze = v((e, t) => {
    let { kConstruct: n } = k(),
      ...
      { iteratorMixin: i, isValidHeaderName: a, isValidHeaderValue: o } = U(),
      { webidl: s } = H(),
      c = y(`node:assert`),
      l = y(`node:util`),
    ...
    var _ = class e {
        ...
        set(e, t, n) {
          this[d] = null;
          let r = n ? e : e.toLowerCase();
          (r === `set-cookie` && (this.cookies = [t]), this[u].set(r, { name: e, value: t }));
        }
        delete(e, t) {
          ((this[d] = null),
            t || (e = e.toLowerCase()),
        ...
        constructor(e = void 0) {
          (s.util.markAsUncloneable(this),
            e !== n &&
              ...
              (this.#e = `none`),
              e !== void 0 &&
                ((e = s.converters.HeadersInit(e, `Headers contructor`, `init`)), m(this, e))));
        }
        append(t, n) {
    ...
    let { getHeadersGuard: b, setHeadersGuard: x, getHeadersList: S, setHeadersList: C } = v;
    (Reflect.deleteProperty(v, `getHeadersGuard`),
      ...
      (s.converters.HeadersInit = function (e, t, n) {
        if (s.util.Type(e) === `Object`) {
          ...
          if (!l.types.isProxy(e) && r === v.prototype.entries)
            try {
  ...
  Be = v((e, t) => {
    ...
    var R = class e {
      ...
      clone() {
        ...
        let t = z(this[O]);
        return (
          d && this[O].body?.stream && f.register(this, new WeakRef(this[O].body.stream)),
          J(t, a(this[A]))
        );
      }
    ...
    function W(e, t) {
      if (t === `basic`) return ie(e, { type: `basic`, headersList: e.headersList });
      if (t === `cors`) return ie(e, { type: `cors`, headersList: e.headersList });
      if (t === `opaque`)
        return ie(e, {
          type: `opaque`,
    ...
    function K(e, t = null) {
      return (
        ...
        b(e)
          ...
          : B(Object.assign(new DOMException(`Request was cancelled.`), { cause: t }))
      );
    }
    function q(e, t, n) {
      ...
      if (
        ...
        `statusText` in t && t.statusText != null && (e[O].statusText = t.statusText),
  ...
  He = v((e, t) => {
    let { extractBody: n, mixinBody: r, cloneBody: i, bodyUnusable: a } = oe(),
      {
        Headers: o,
        fill: s,
        HeadersList: c,
      ...
      m = N(),
      h = y(`node:util`),
      { isValidHTTPToken: g, sameOrigin: _, environmentSettingsObject: v } = U(),
      {
        forbiddenMethodsSet: b,
      ...
      { kEnumerableProperty: O, normalizedMethodRecordsBase: A, normalizedMethodRecords: j } = m,
      ...
      W = Symbol(`abortController`),
      G = new p(({ signal: e, abort: t }) => {
    ...
    var se = class e {
      constructor(t, r = {}) {
        ...
        if (
          ...
          if (e === ``) u.referrer = `no-referrer`;
            ...
            (S && !_(t, v.settingsObject.baseUrl))
              ? (u.referrer = `client`)
              : (u.referrer = t);
          }
        }
        ...
        if (((this[P] = E.signal), y != null)) {
          if (!y || typeof y.aborted != `boolean` || typeof y.addEventListener != `function`)
            throw TypeError(
          ...
          if (y.aborted) E.abort(y.reason);
            ...
            try {
              ((typeof te == `function` && te(y) === ie) || ne(y, `abort`).length >= ie) &&
                B(1500, y);
            } catch {}
            (m.addAbortListener(y, e), G.register(E, { signal: y, abort: e }, e));
          }
        }
        if (
          ((this[M] = new o(R)), d(this[M], u.headersList), l(this[M], `request`), T === `no-cors`)
        ) {
        ...
        if (r.body != null) {
          ...
          ((O = e),
            t && !f(this[M]).contains(`content-type`, !0) && this[M].append(`content-type`, t));
        }
        let k = O ?? D;
        ...
        if (O == null && D != null) {
          ...
          (D.stream.pipeThrough(e),
            (N = { source: D.source, length: D.length, stream: e.readable }));
        }
        this[F].body = N;
      }
      get method() {
      ...
      clone() {
        ...
        if (this.signal.aborted) n.abort(this.signal.reason);
          ...
          e === void 0 && ((e = new Set()), K.set(this.signal, e));
          let t = new WeakRef(n);
    ...
    (Object.defineProperties(se.prototype, {
      ...
      (L.converters.Request = L.interfaceConverter(se)),
      ...
      (L.converters.RequestInit = L.dictionaryConverter([
        ...
        { key: `body`, converter: L.nullableConverter(L.converters.BodyInit) },
        { key: `referrer`, converter: L.converters.USVString },
        { key: `referrerPolicy`, converter: L.converters.DOMString, allowedValues: S },
        { key: `mode`, converter: L.converters.DOMString, allowedValues: w },
        { key: `credentials`, converter: L.converters.DOMString, allowedValues: T },
        { key: `cache`, converter: L.converters.DOMString, allowedValues: E },
        { key: `redirect`, converter: L.converters.DOMString, allowedValues: C },
        ...
        { key: `keepalive`, converter: L.converters.boolean },
        {
          ...
          converter: L.nullableConverter((e) =>
            L.converters.AbortSignal(e, `RequestInit`, `signal`, { strict: !1 }),
          ),
        },
        { key: `window`, converter: L.converters.any },
        { key: `duplex`, converter: L.converters.DOMString, allowedValues: D },
  ...
  Ue = v((e, t) => {
    let {
      ...
      { kState: G, kDispatcher: K } = ae(),
      q = y(`node:assert`),
      { safelyExtractBody: J, extractBody: se } = oe(),
      {
        redirectStatusSet: Y,
        nullBodyStatus: ce,
        safeMethodsSet: le,
      ...
      de = y(`node:events`),
      { Readable: fe, pipeline: pe, finished: me } = y(`node:stream`),
      { addAbortListener: Z, isErrored: Q, isReadable: he, bufferToLowerCasedHeaderName: $ } = N(),
      { dataURLProcessor: ge, serializeAMimeType: _e, minimizeSupportedMimeType: ve } = V(),
      { getGlobalDispatcher: ye } = Ne(),
      { webidl: be } = H(),
      { STATUS_CODES: xe } = y(`node:http`),
      Se = [`GET`, `HEAD`],
    ...
    async function Me(e, t = !1) {
      let r = e.request,
        a = null;
      if (
        (r.localURLsOnly && !ee(v(r)) && (a = n(`local URLs only`)),
        x(r),
          ...
          (e.request.destination === `document` && (e.controller.fullTimingInfo = n),
            (e.controller.reportTimingSteps = () => {
              ...
              e.request.initiatorType != null &&
                ke(n, e.request.url.href, e.request.initiatorType, globalThis, i, a, o);
            }));
          let i = () => {
            ((e.request.done = !0),
    ...
    function Re(e, t) {
      ...
      if (((r.redirectCount += 1), r.mode === `cors` && (a.username || a.password) && !A(r, a)))
      ...
      let o = e.timingInfo;
      return (
        (o.redirectEndTime = o.postRedirectStartTime = D(e.crossOriginIsolatedCapability)),
    ...
    async function Ve(e, t = !1, i = !1) {
      ...
      if (
        ...
        d != null && s.keepalive,
        s.referrer instanceof URL && s.headersList.append(`referer`, L(s.referrer.href), !0),
        g(s),
        C(s),
      ...
      if (
        ...
        return a.window === `no-window` ? n() : j(e) ? r(e) : n(`proxy authentication required`);
            ...
            },
            {
              ...
              onConnect(t) {
                ...
                ((l.finalConnectionTimingInfo = te(
                  ...
                  (l.finalNetworkRequestStartTime = D(e.crossOriginIsolatedCapability)));
              },
              onResponseStarted() {
    ...
    t.exports = { fetch: De, Fetch: Te, fetching: je, finalizeAndReportTiming: Oe };
  }),
  We = v((e, t) => {
    t.exports = {
  ...
  qe = v((e, t) => {
    let { kState: n, kError: r, kResult: i, kAborted: a, kLastProgressEventFired: o } = We(),
      { ProgressEvent: s } = Ge(),
      { getEncoding: c } = Ke(),
      { serializeAMimeType: l, parseMIMEType: u } = V(),
      { types: d } = y(`node:util`),
      { StringDecoder: f } = y(`string_decoder`),
      { btoa: p } = y(`node:buffer`),
    ...
    t.exports = { staticPropertyDescriptors: m, readOperation: h, fireAProgressEvent: g };
  }),
  Je = v((e, t) => {
    let { staticPropertyDescriptors: n, readOperation: r, fireAProgressEvent: i } = qe(),
  ...
  Ze = v((e, t) => {
    let { kConstruct: n } = Ye(),
      ...
      { kState: p } = ae(),
      { fetching: m } = Ue(),
      { urlIsHttpHttpsScheme: h, createDeferredPromise: g, readAllBytes: _ } = U(),
      v = y(`node:assert`);
    var b = class e {
      #e;
      constructor() {
      ...
      async put(t, n) {
        ...
        let a = null;
        if (((a = t instanceof d ? t[p] : new d(t)[p]), !h(a.url) || a.method !== `GET`))
          throw s.errors.exception({
            header: r,
  ...
  rt = v((e, t) => {
    let { webidl: n } = H(),
      { kEnumerableProperty: r } = N(),
      { kConstruct: i } = k(),
      { MessagePort: a } = y(`node:worker_threads`);
  ...
  ot = v((e, t) => {
    let { kReadyState: n, kController: r, kResponse: i, kBinaryType: a, kWebSocketURL: o } = at(),
      { states: s, opcodes: c } = it(),
      { ErrorEvent: l, createFastMessageEvent: u } = rt(),
      { isUtf8: d } = y(`node:buffer`),
      { collectASequenceOfCodePointsFast: f, removeHTTPWhitespace: p } = V();
    function m(e) {
    ...
    function b(e, t, r) {
      ...
      v(`message`, e, u, { origin: e[o].origin, data: i });
    }
    function x(e) {
    ...
    function w(e, t) {
      ...
      (n.abort(),
        ...
        t && v(`error`, e, (e, t) => new l(e, t), { error: Error(t), message: t }));
    }
    function T(e) {
  ...
  ct = v((e, t) => {
    let { uid: n, states: r, sentCloseFrameState: i, emptyBuffer: a, opcodes: o } = it(),
      { kReadyState: s, kSentClose: c, kByteParser: l, kReceivedClose: u, kResponse: d } = at(),
      {
        fireEvent: f,
        ...
        S({
          ...
          processResponse(e) {
            ...
            (e.socket.on(`data`, A),
              e.socket.on(`close`, j),
              e.socket.on(`error`, M),
              v.open.hasSubscribers &&
                v.open.publish({ address: e.socket.address(), protocol: s, extensions: r }),
              a(e, o));
          },
        })
      );
    ...
    function j() {
      ...
      let n = e[c] === i.SENT && e[u],
        ...
        o = ``,
        p = e[l].closingInfo;
      (p && !p.error ? ((a = p.code ?? 1005), (o = p.reason)) : e[u] || (a = 1006),
        (e[s] = r.CLOSED),
        f(`close`, e, (e, t) => new b(e, t), { wasClean: n, code: a, reason: o }),
        v.close.hasSubscribers && v.close.publish({ websocket: e, code: a, reason: o }));
    }
    function M(e) {
      let { ws: t } = this;
      ((t[s] = r.CLOSING),
        v.socketError.hasSubscribers && v.socketError.publish(e),
        this.destroy());
    }
    t.exports = { establishWebSocketConnection: O, closeWebSocketConnection: k };
  }),
  lt = v((e, t) => {
    let { createInflateRaw: n, Z_DEFAULT_WINDOWBITS: r } = y(`node:zlib`),
  ...
  ut = v((e, t) => {
    let { Writable: n } = y(`node:stream`),
      r = y(`node:assert`),
      { parserStates: i, opcodes: a, states: o, emptyBuffer: s, sentCloseFrameState: c } = it(),
      ...
      ByteParser: class extends n {
        ...
        constructor(e, t, n = {}) {
          (super(),
            ...
            this.#s.has(`permessage-deflate`) && this.#s.set(`permessage-deflate`, new T(t, n)));
        }
        _write(e, t, n) {
          (this.#e.push(e), (this.#n += e.length), (this.#r = !0), this.run(n));
        }
        #l() {
          return this.#c > 0 && !b(this.#a.opcode) && this.#a.payloadLength > this.#c
        ...
        run(e) {
          for (; this.#r; )
            if (this.#i === i.INFO) {
              ...
              if (c <= 125) {
                if (((this.#a.payloadLength = c), (this.#i = i.READ_DATA), !this.#l())) return;
              } else
                c === 126
                  ? (this.#i = i.PAYLOADLENGTH_16)
                  : c === 127 && (this.#i = i.PAYLOADLENGTH_64);
              (x(r) && ((this.#a.binaryType = r), (this.#a.compressed = l !== 0)),
                (this.#a.opcode = r),
                (this.#a.masked = o),
                (this.#a.fin = n),
                (this.#a.fragmented = s));
              ...
              let t = this.consume(2);
              if (
                ((this.#a.payloadLength = t.readUInt16BE(0)), (this.#i = i.READ_DATA), !this.#l())
              )
                return;
              ...
              if (((this.#a.payloadLength = r), (this.#i = i.READ_DATA), !this.#l())) return;
              ...
              if (b(this.#a.opcode)) ((this.#r = this.parseControlFrame(t)), (this.#i = i.INFO));
                ...
                (this.#s.get(`permessage-deflate`).decompress(t, this.#a.fin, (t, n) => {
                  ...
                  if ((this.writeFragments(n), this.#c > 0 && this.#t > this.#c)) {
                ...
                if ((this.writeFragments(t), this.#c > 0 && this.#t > this.#c)) {
                  g(this.ws, new E().message);
                  return;
                }
                (!this.#a.fragmented &&
  ...
  ft = v((e, t) => {
    let { webidl: n } = H(),
      ...
      { staticPropertyDescriptors: a, states: o, sentCloseFrameState: s, sendHints: c } = it(),
      {
        kWebSocketURL: l,
        kReadyState: u,
        kController: d,
    ...
    var M = class e extends EventTarget {
      ...
      set binaryType(t) {
        (n.brandCheck(this, e),
          t !== `blob` && t !== `arraybuffer` ? (this[f] = `blob`) : (this[f] = t));
      }
      #a(e, t) {
        this[p] = e;
    ...
    ((M.CONNECTING = M.prototype.CONNECTING = o.CONNECTING),
      ...
      Object.defineProperties(M, { CONNECTING: a, OPEN: a, CLOSING: a, CLOSED: a }),
      ...
      (n.converters.WebSocketInit = n.dictionaryConverter([
        ...
        { key: `dispatcher`, converter: n.converters.any, defaultValue: () => D() },
  ...
  gt = v((e, t) => {
    ...
    (Object.assign(r.prototype, p),
      ...
      (t.exports.interceptors = { redirect: Fe(), retry: Ie(), dump: Le(), dns: Re() }),
    ...
    ((t.exports.fetch = async function (e, t = void 0) {
      ...
      (t.exports.FormData = G().FormData),
      (t.exports.File = globalThis.File ?? y(`node:buffer`).File),
    ...
    let { deleteCookie: P, getCookies: F, getSetCookies: L, setCookie: ee } = nt();
...
const { access: xt, appendFile: St, writeFile: Ct } = s,
...
new (class {
  ...
  write(e) {
    return bt(this, void 0, void 0, function* () {
      ...
      return (yield (t ? Ct : St)(n, this._buffer, { encoding: `utf8` }), this.emptyBuffer());
    });
  }
  clear() {
    return bt(this, void 0, void 0, function* () {
...
function Vt(e) {
  return (
    (e ||= ``),
    Rt ? ((e = e.replace(/\//g, `\\`)), e.replace(/\\\\+/g, `\\`)) : e.replace(/\/\/+/g, `/`)
  );
}
function Ht(e) {
  return (
    (e.mode & 1) > 0 ||
    ((e.mode & 8) > 0 && process.getgid !== void 0 && e.gid === process.getgid()) ||
    ((e.mode & 64) > 0 && process.getuid !== void 0 && e.uid === process.getuid())
  );
}
...
function Gt(e) {
  return Ut(this, void 0, void 0, function* () {
    ...
    if (Rt && process.env.PATHEXT)
      for (let e of process.env.PATHEXT.split(c.delimiter)) e && t.push(e);
    if (zt(e)) {
      let n = yield Bt(e, t);
      return n ? [n] : [];
    }
...
(process.platform, l.EventEmitter, l.EventEmitter, n.platform(), n.arch());
var Kt;
(function (e) {
...
`)
    .filter((e) => e !== ``);
  return t && t.trimWhitespace === !1 ? n : n.map((e) => e.trim());
}
function Yt(e, t) {
...
function Zt(e, t) {
  e.startsWith(`0.`) && (t === `major` ? (t = `minor`) : t === `minor` && (t = `patch`));
  let n = e.split(`.`);
  if (($t(`current`, n), t === `major`)) {
    Qt(e, t);
    let [r] = n;
    return `${parseInt(r) + 1}.0.0`;
  } else if (t === `minor`) {
    Qt(e, t);
    let [r, i] = n;
    return `${r}.${parseInt(i) + 1}.0`;
  } else if (t === `patch`) {
    Qt(e, t);
    let [r, i, a] = n;
    return `${r}.${i}.${parseInt(a) + 1}`;
  } else return ($t(`bumped`, t.split(`.`)), t);
}
function Qt(e, t) {
  if (e.includes(`-`))
    throw Error(
      `Relative version bump (${t}) not allowed when the current version is in pre-release. Use a hardcoded version instead.`,
    );
}
function $t(e, t) {
  if (t.length < 3) throw Error(`Invalid semver in ${e} version: ${t.join(`.`)}`);
}
async function en(e) {
  if ((console.log(`Creating GitHub release...`), e.dryRun)) console.log(`  -> Skipping, dry run`);
  else throw Error(`TODO`);
  for (let t of e.artifacts ?? [])
    if ((console.log(`Uploading ${u(`cyan`, t)}...`), e.dryRun))
      console.log(`  -> Skipping, dry run`);
    else throw Error(`TODO`);
}
function tn(e) {
  throw (console.log(`Detecting version bump based on changes...`), Error(`TODO`));
}
function nn(e) {
  throw Error(`TODO`);
}
const rn = /"version":\s*?"(?<version>)"/,
  an = /["']?version["']?:\s+?["']?(?<version>)["']?/,
  on = /^version\s*=\s*"(?<version>\w*?)"/;
function sn(e) {
  let t = p(e);
  switch (t) {
    case `package.json`:
    ...
    case `Cargo.toml`:
      return on;
    default:
      throw Error(`Unknown version file: ${t}`);
  }
}
  ...
  for (let n of t)
    try {
      let t = m(e, n),
        r = await d(t, `utf8`),
        i = sn(t),
        a = r.match(i)?.groups?.version;
      if (a)
        return (
          console.log(`Found current version (${a})) in ${u(`cyan`, h(process.cwd(), t))}`), a
        );
      console.log(`  -> Not found in ${u(`cyan`, h(process.cwd(), t))}`);
    } catch (e) {
...
async function un(e) {
  if ((console.log(`Running command:`, e), e.dryRun)) {
    console.log(`  -> Skipping, dry run`);
    return;
  }
  return new Promise((t, n) => {
    let r = _(e.cmd, { cwd: e.cwd }, (e) => {
      if (e) return n(e);
      t();
    });
    (r.stderr?.on(`data`, (e) => {
...
function fn(e, t) {
  return Object.entries(t).reduce(
    (e, [t, n]) => e.replace(RegExp(`\\{\\{\\s*?${t}\\s*?\\}\\}`, `g`), String(n)),
    e,
  );
}
function pn(e) {
  throw (
    console.log(`Listing commits ${e.since ? `since ` + e.since : `for all time`}`), Error(`TODO`)
  );
}
function mn(e) {
  let t = e.split(/\n\r?/),
...
function gn(e) {
  return e.map(hn).filter((e) => e != null);
}
function _n(e) {
  let t = [`# Changelog`];
  for (let n of e) t.push(`## ${n.header}`, n.body);
  return (
    t.join(`
...
async function vn(e, t, n) {
  ...
  for (let r of t) await yn(e, r, n);
}
async function yn(e, t, n) {
  let r = m(e, t),
    i = h(process.cwd(), r);
  try {
    (await f(r, dn(await d(r, `utf8`), sn(r), `version`, n), `utf8`),
      console.log(`  -> ${u(`cyan`, i)} updated`));
  } catch (e) {
    if (e.code === `ENOENT`) {
      console.log(`  -> ${u(`cyan`, i)} does not exist, skipping`);
      return;
    }
    throw e;
  }
...
async function bn(e) {
  let {
      additionalDirs: t = [],
      commitTemplate: n = `chore(release): v{{version}}`,
      dryRun: r = !1,
      dryRunPublishCommands: i,
      publishCommands: a,
      releaseTitleTemplate: o = `{{tag}}`,
      versionFiles: s = [`package.json`, `jsr.json`, `deno.json`, `Cargo.toml`],
      releaseArtifacts: c = [],
    } = e,
    l = process.cwd(),
    u = e.path ? g(e.path) : l,
    ...
    h = u === l ? `v` : `${m}-v`,
    _ = await cn(u, s),
    v = gn(pn({ since: e.since ?? (await nn(h)), dirs: [u, ...t] })),
    y = ln(v),
    b = Zt(_, e.bump ?? tn(v)),
    x = h + b;
  await vn(u, s, b);
  let S = mn(await d(`CHANGELOG.md`, `utf8`));
  if (
    (S.unshift({ header: `v${b}`, body: y }),
    await f(`CHANGELOG.md`, _n(S), `utf8`),
    r && i?.length)
  )
    for (let e of i) await un({ dryRun: !1, cwd: u, cmd: e });
  else if (a?.length) for (let e of a) await un({ dryRun: r, cwd: u, cmd: e });
  throw (
    await un({
      dryRun: r,
      cwd: u,
      cmd: `git commit -am "${fn(n, { version: b, path: u, dirname: m })}"`,
    }),
    await un({ dryRun: r, cwd: u, cmd: `git tag ${x}` }),
    await un({ dryRun: r, cwd: u, cmd: `git push` }),
    await un({ dryRun: r, cwd: u, cmd: `git push --tags` }),
    await en({
      dryRun: r,
      tag: x,
      title: fn(o, { version: b, tag: x, path: u, dirname: m }),
      body: y,
      artifacts: c,
    }),
...
async function xn() {
  let e = await bn({
    additionalDirs: Jt(`additionalDirs`),
    bump: qt(`bump`),
    commitTemplate: qt(`commitTemplate`),
    dryRun: Yt(`dryRun`),
    since: qt(`since`),
    dryRunPublishCommands: Jt(`dryRunPublishCommands`),
    path: qt(`path`),
    publishCommands: Jt(`publishCommands`),
    releaseArtifacts: Jt(`releaseArtifacts`),
    releaseTitleTemplate: qt(`releaseTitleTemplate`),
    tagPrefix: qt(`tagPrefix`),
    versionFiles: Jt(`versionFiles`),
  });
  (Xt(`version`, e.version), Xt(`tag`, e.tag), Xt(`releaseNotes`, e.releaseNotes));
}
export { xn as run };
